package com.epam.trainings.gen_ai_task_6.util;

import com.azure.ai.openai.models.EmbeddingItem;
import com.epam.trainings.gen_ai_task_6.model.FoodItem;
...
public class FoodItemEmbeddingHelper {
    ...
    private String storeEmbedding(FoodItem input) throws ExecutionException, InterruptedException {
        ...
        return textEmbeddingService.saveVector(pointStructs, Optional.of("generic-collection"));
    }
