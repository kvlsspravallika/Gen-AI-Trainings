...
import com.epam.trainings.gen_ai_task_6.plugins.model.UserContext;
...
import com.epam.trainings.gen_ai_task_6.plugins.service.PaymentService;
import com.epam.trainings.gen_ai_task_6.plugins.service.PizzaService;
...
public class OrderPizzaPlugin {
    ...
    @DefineKernelFunction(name = "getPizzaMenu", description = "Get the pizza menu.", returnType = "com.epam.trainings.gen_ai_task_6.plugins.model.pizza.PizzaMenu")
    ...
    @DefineKernelFunction(
            ...
            returnType = "com.epam.trainings.gen_ai_task_6.plugins.model.cart.CartDelta")
    public Mono<CartDelta> addPizzaToCart(
            @KernelFunctionParameter(name = "size", description = "The size of the pizza", type = PizzaSize.class, required = true)
            PizzaSize size,
    ...
    @DefineKernelFunction(name = "remove_pizza_from_cart", description = "Remove a pizza from the cart.", returnType = "com.epam.trainings.gen_ai_task_6.plugins.model.pizza.RemovePizzaResponse")
    ...
    @DefineKernelFunction(
            ...
            returnType = "com.epam.trainings.gen_ai_task_6.plugins.model.pizza.Pizza")
    ...
    @DefineKernelFunction(
            ...
            returnType = "com.epam.trainings.gen_ai_task_6.plugins.model.cart.Cart")
